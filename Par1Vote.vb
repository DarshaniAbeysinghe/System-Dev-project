...
Public Class Par1Vote
    ...
    Private Sub Par1Vote_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        loadlist()
    ...
    Private Sub LoadDataForSelectedPictureBox()
        If selectedPictureBox IsNot Nothing Then
            ...
            Dim voterQuery As String = "SELECT `First_Name`, `District` FROM `voter_registration` WHERE Nic = @Nic"
                ...
                cmdVoter.Parameters.AddWithValue("@Nic", Loging_Form_Par.Txtnic.Text)
    ...
    Sub update_votervotestatus()
        Try
            ...
            Dim query As String
            query = "UPDATE voter_registration SET Parstatus=@Parstatus WHERE Nic=@Nic"
            cmd = New MySqlCommand(query, dbconn)
            cmd.Parameters.Clear()
            cmd.Parameters.AddWithValue("@Parstatus", "Voted")
            cmd.Parameters.AddWithValue("@Nic", value:=Loging_Form_Par.Txtnic.Text)
    ...
    Private Sub Guna2GradientButton4_Click(sender As Object, e As EventArgs) Handles Guna2GradientButton4.Click
        Try
            ...
            For j As Integer = 0 To Dgv1.Rows.Count - 2
                Dim query As String
                query = "INSERT INTO parvoting_details(Nic, Time,District,Selected_Party) VALUES (@Nic, @Time,@District, @Selected_Party)"
                cmd = New MySqlCommand(query, dbconn)
                cmd.Parameters.Clear()
