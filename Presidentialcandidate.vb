...
Public Class Presidentialcandidate
    ...
    Dim data As New MySqlDataAdapter("SELECT ID,First_Name,Last_Name,Nic,Gender,TpNo,Dob,Province,District,Party From Presidential_election_candidate_registration", dbconn)
    Dim dr As MySqlDataReader
    Dim result As Boolean
    Dim i As Integer

    Private First_Name, Last_Name, Nic, TpNo, Dob, Province, District, Party As String
    ...
    Private Sub Button4_Click(sender As Object, e As EventArgs) Handles Button4.Click
        ...
        If result = DialogResult.Yes Then
            Try
                ...
                Dim deleteQuery As String = "DELETE FROM Presidential_election_candidate_registration WHERE ID=@id"
    ...
    Private Sub Btnupdate_Click(sender As Object, e As EventArgs) Handles Btnupdate.Click
        Try
            ...
            ElseIf Nic.Length <> 12 Or Not System.Text.RegularExpressions.Regex.IsMatch(Nic, pattern2) Then
                MsgBox("Invalid NIC. NIC should be 12 digits.")
            ElseIf tpno = "" Or Not System.Text.RegularExpressions.Regex.IsMatch(tpno, pattern) Then
                MsgBox("Invalid phone number. Please add a valid phone number.")
            ElseIf Dob = "" Then
            ...
            Else
                ...
                Dim query As String = "UPDATE Presidential_election_candidate_registration " &
    ...
    Private Sub Btnregister_Click(sender As Object, e As EventArgs) Handles Btnregister.Click
        ...
        Try
            ...
            Else
                ...
                Dim query As String
                query = "INSERT INTO Presidential_election_candidate_registration(Img,First_Name,Last_Name,Nic,Dob,Gender,TpNo,province,district,Party)values(@Img,@First_Name,@Last_Name,@Nic,@Dob,@Gender,@TpNo,@province,@district,@Party)"
                cmd = New MySqlCommand(query, dbconn)
    ...
    Private Sub bindData()
        ...
        Dgv1.DataSource = dt
    End Sub
    Private Sub DDDD_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        bindData()
