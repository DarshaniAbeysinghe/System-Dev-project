...
Public Class Psloging
    ...
    Dim i As Integer
    Private Sub Psloging_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Txtnic.Clear()
    ...
    Private Sub Guna2GradientButton2_Click(sender As Object, e As EventArgs) Handles Guna2GradientButton2.Click
        ...
        Else
            Try
                ...
                cmd = New MySqlCommand("SELECT * FROM voter_registration WHERE Nic=@Nic AND psstatus=@psstatus", dbconn)
                cmd.Parameters.Clear()
                cmd.Parameters.AddWithValue("@Nic", Txtnic.Text)
                cmd.Parameters.AddWithValue("@psstatus", "Un-Voted")
                ...
                If dt.Rows.Count > 0 Then
                    Me.Hide()
                    Psloging2.ShowDialog()


                Else
                    cmd = New MySqlCommand("SELECT psstatus FROM voter_registration WHERE Nic=@Nic", dbconn)
                    cmd.Parameters.Clear()
                    cmd.Parameters.AddWithValue("@Nic", Txtnic.Text)
